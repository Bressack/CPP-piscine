...
/*   Updated: 2021/05/26 21:29:57 by tharchen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << std::setfill(' ') << std::setw(10) << this->get_index() << " | ";
	std::cout << std::setfill(' ') << std::setw(10) << this->get_first_name() << " | ";
	std::cout << std::setfill(' ') << std::setw(10) << this->get_last_name() << " | ";
	std::cout << std::setfill(' ') << std::setw(10) << this->get_login() << " | ";
	std::cout << std::endl;
}
